...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(PC15_GPIO_Port, PC15_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_SDI_Pin|LED_CLK_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : PC15_Pin */
  GPIO_InitStruct.Pin = PC15_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(PC15_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : UP_Pin DOWN_Pin TIM_SET_Pin LED_ON_Pin
                           LIGHT_Pin */
  GPIO_InitStruct.Pin = UP_Pin|DOWN_Pin|TIM_SET_Pin|LED_ON_Pin
                          |LIGHT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  ...
  /*Configure GPIO pins : LED_OEA_Pin LED_OEB_Pin LED_LE_Pin LED_SDI_Pin
                           LED_CLK_Pin P03_Pin P04_Pin */
  GPIO_InitStruct.Pin = LED_OEA_Pin|LED_OEB_Pin|LED_LE_Pin|LED_SDI_Pin
                          |LED_CLK_Pin|P03_Pin|P04_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
